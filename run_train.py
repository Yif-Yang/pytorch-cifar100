...
parser.add_argument('-exp_name', type=str, default='Distill_Dis_NoPick', help='exp_name ')
...
parser.add_argument('-no_hm', action='store_true', default=True, help='add_dis_w training')
